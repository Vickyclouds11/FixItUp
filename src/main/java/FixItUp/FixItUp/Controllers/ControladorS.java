...
import FixItUp.FixItUp.Servicios.ServicioS;
...
public class ControladorS {
    ...
    @Autowired
    public ControladorS(ServicioS servicio) {
        this.servicio = servicio;
        this.sesionIniciada = false;
    }

    @PostMapping("/iniciar-sesionn")
    ...
    @PostMapping("/Post/Serv")
    public Servicio agregar(@RequestBody Servicio serv) {
        return servicio.agregarUsuario(serv);
    }
